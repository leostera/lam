...
\setboolean{shading}{true}
 ...
 Sequences}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 4\hspace{1em}} {\CONSTANTS} InstrCount ,\,
 RegisterCount ,\, Nil}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}} RegisterKinds \.{\defeq}
 \{\@w{local} ,\,\@w{global} \}}%
\@pvspace{8.0pt}%
\pcalsymbolstrue
\pcalshadingtrue
\csyntaxfalse
 \@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}}\@s{12.29} {\p@mmalgorithm}
 LAM\_ISA\_Move}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}} {\p@variables}}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{8.2} global\_registers
 \.{=} ( 0 \.{\dotdot} RegisterCount ) \.{\times} \{ Nil \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{8.2} local\_registers
 \.{=} ( 0 \.{\dotdot} RegisterCount ) \.{\times} \{ Nil \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{8.2} current\_count \.{=}
 InstrCount ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}\@s{8.2} current\_move \.{=}
 Nil}%
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{8.2} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} {\p@define}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{8.2} AllRegistersAreValid
 \.{\defeq} \.{\lor} current\_move \.{=} Nil}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{117.77} \.{\lor}
 \.{\land} current\_move . dst [ 1 ] \.{\in} RegisterKinds}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{128.88} \.{\land}
 current\_move . src [ 1 ]\@s{0.51} \.{\in} RegisterKinds}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{128.88} \.{\land}
 current\_move . dst [ 2 ] \.{\in} ( 0 \.{\dotdot} RegisterCount )}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{128.88} \.{\land}
 current\_move . src [ 2 ]\@s{0.51} \.{\in} ( 0 \.{\dotdot} RegisterCount )}%
\@pvspace{8.0pt}%
...
\@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}} {\p@begin}}%
 ...
 Run\@s{.5}\textrm{:}\@s{3}}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{16.4} {\p@while}
 current\_count \.{>} 0 {\p@do}}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{24.59}
 MakeMove\@s{.5}\textrm{:}\@s{3}}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{32.8} current\_move
 \.{:=} [}%
\@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{49.19} src \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{57.39} {\CHOOSE}
 k\@s{0.71} \.{\in} RegisterKinds \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{57.39} {\CHOOSE} n
 \.{\in} ( 0 \.{\dotdot} RegisterCount ) \.{:} {\langle} k ,\, n {\rangle}
 ,\,}%
\@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{49.19} dst \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{57.39} {\CHOOSE}
 k\@s{0.71} \.{\in} RegisterKinds \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{57.39} {\CHOOSE} n
 \.{\in} ( 0 \.{\dotdot} RegisterCount ) \.{:} {\langle} k ,\, n {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{32.8} ] {\p@semicolon}}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{32.8} current\_count
 \.{:=} current\_count \.{-} 1 {\p@semicolon}}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{24.59} {\p@call}
 perform\_move ( current\_move ) {\p@semicolon}}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{16.4} {\p@end} {\p@while}
 {\p@semicolon}}%
\@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} {\p@end} {\p@algorithm}}%
\@y{%
 ;
}%
\@xx{}%
...
\@y{\@s{0}%
 BEGIN TRANSLATION (\ensuremath{chksum(pcal) \.{=}} ``\ensuremath{c6cc4c7}''
 \ensuremath{\.{\land} chksum(tla) \.{=}} ``\ensuremath{c697ae07}'')
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}} {\CONSTANT}
 defaultInitValue}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}} {\VARIABLES}
 global\_registers ,\, local\_registers ,\, current\_count ,\, current\_move
 ,\, pc ,\,}%
\@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{51.42} stack}%
\@pvspace{8.0pt}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}} AllRegistersAreValid
 \.{\defeq} \.{\lor} current\_move \.{=} Nil}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{109.57} \.{\lor}
 \.{\land} current\_move . dst [ 1 ] \.{\in} RegisterKinds}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{120.68} \.{\land}
 current\_move . src [ 1 ]\@s{0.51} \.{\in} RegisterKinds}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{120.68} \.{\land}
 current\_move . dst [ 2 ] \.{\in} ( 0 \.{\dotdot} RegisterCount )}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{120.68} \.{\land}
 current\_move . src [ 2 ]\@s{0.51} \.{\in} ( 0 \.{\dotdot} RegisterCount )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}} {\VARIABLE} move}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}} vars\@s{5.19} \.{\defeq}
 {\langle} global\_registers ,\, local\_registers ,\, current\_count ,\,
 current\_move ,\, pc ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{46.80} stack ,\, move
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}} Init\@s{7.21} \.{\defeq}}%
\@y{\@s{0}%
 Global variables
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{42.91} \.{\land}
 global\_registers \.{=} ( 0 \.{\dotdot} RegisterCount ) \.{\times} \{ Nil
 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{42.91} \.{\land}
 local\_registers \.{=} ( 0 \.{\dotdot} RegisterCount ) \.{\times} \{ Nil \}}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{42.91} \.{\land}
 current\_count \.{=} InstrCount}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{42.91} \.{\land}
 current\_move \.{=} Nil}%
\@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{42.91}}%
\@y{\@s{0}%
 Procedure \ensuremath{perform\_move
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{42.91} \.{\land} move
 \.{=} defaultInitValue}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{42.91} \.{\land} stack
 \.{=} {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{42.91} \.{\land} pc
 \.{=}\@w{Run}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}} Move \.{\defeq} \.{\land} pc
 \.{=}\@w{Move}}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{42.91} \.{\land} {\IF}
 move . dst [ 1 ] \.{=}\@w{global} \.{\land} move . src [ 1 ]
 \.{=}\@w{global}}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}\@s{66.18} \.{\THEN}
 \.{\land} global\_registers \.{'} \.{=} [ global\_registers {\EXCEPT}
 {\bang} [ move . dst [ 2 ] ] \.{=} global\_registers [ move . src [ 2 ] ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{97.49} \.{\land}
 {\UNCHANGED} local\_registers}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}\@s{66.18} \.{\ELSE}
 \.{\land} {\IF} move . dst [ 1 ] \.{=}\@w{local} \.{\land} move . src [ 1 ]
 \.{=}\@w{local}}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{120.76} \.{\THEN}
 \.{\land} local\_registers \.{'} \.{=} [ local\_registers {\EXCEPT} {\bang}
 [ move . dst [ 2 ] ] \.{=} local\_registers [ move . src [ 2 ] ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{152.07} \.{\land}
 {\UNCHANGED} global\_registers}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{120.76} \.{\ELSE}
 \.{\land} {\IF} move . dst [ 1 ] \.{=}\@w{global} \.{\land} move . src [ 1 ]
 \.{=}\@w{local}}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{175.33} \.{\THEN}
 \.{\land} global\_registers \.{'} \.{=} [ global\_registers {\EXCEPT}
 {\bang} [ move . dst [ 2 ] ] \.{=} local\_registers [ move . src [ 2 ] ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{206.64} \.{\land}
 {\UNCHANGED} local\_registers}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{175.33} \.{\ELSE}
 \.{\land} {\IF} move . dst [ 1 ] \.{=}\@w{local} \.{\land} move . src [ 1 ]
 \.{=}\@w{global}}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{229.91} \.{\THEN}
 \.{\land} local\_registers \.{'} \.{=} [ local\_registers {\EXCEPT} {\bang}
 [ move . dst [ 2 ] ] \.{=} global\_registers [ move . src [ 2 ] ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{229.91} \.{\ELSE}
 \.{\land} {\TRUE}}%
 \@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}}\@s{261.22} \.{\land}
 {\UNCHANGED} local\_registers}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{206.64} \.{\land}
 {\UNCHANGED} global\_registers}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{42.91} \.{\land} pc \.{'}
 \.{=} Head ( stack ) . pc}%
 \@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}}\@s{42.91} \.{\land} move
 \.{'} \.{=} Head ( stack ) . move}%
 \@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}}\@s{42.91} \.{\land} stack
 \.{'} \.{=} Tail ( stack )}%
 \@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}}\@s{42.91} \.{\land}
 {\UNCHANGED} {\langle} current\_count ,\, current\_move {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}} perform\_move \.{\defeq}
 Move}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}} Run \.{\defeq} \.{\land} pc
 \.{=}\@w{Run}}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{37.68} \.{\land} {\IF}
 current\_count \.{>} 0}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{60.94} \.{\THEN}
 \.{\land} pc \.{'} \.{=}\@w{MakeMove}}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{60.94} \.{\ELSE}
 \.{\land} pc \.{'} \.{=}\@w{Done}}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{37.68} \.{\land}
 {\UNCHANGED} {\langle} global\_registers ,\, local\_registers ,\,
 current\_count ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@s{111.27} current\_move
 ,\, stack ,\, move {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}} MakeMove \.{\defeq}
 \.{\land} pc \.{=}\@w{MakeMove}}%
 \@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}}\@s{66.19} \.{\land}
 current\_move \.{'} \.{=}\@s{65.6} [}%
\@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}}\@s{164.83} src \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}}\@s{173.03} {\CHOOSE}
 k\@s{0.71} \.{\in} RegisterKinds \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}}\@s{173.03} {\CHOOSE} n
 \.{\in} ( 0 \.{\dotdot} RegisterCount ) \.{:} {\langle} k ,\, n {\rangle}
 ,\,}%
\@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}}\@s{164.83} dst \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}}\@s{173.03} {\CHOOSE}
 k\@s{0.71} \.{\in} RegisterKinds \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}}\@s{173.03} {\CHOOSE} n
 \.{\in} ( 0 \.{\dotdot} RegisterCount ) \.{:} {\langle} k ,\, n {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}}\@s{148.43} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}}\@s{66.19} \.{\land}
 current\_count \.{'} \.{=} current\_count \.{-} 1}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}}\@s{66.19} \.{\land}
 \.{\land} move \.{'} \.{=} current\_move \.{'}}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}}\@s{77.30} \.{\land} stack
 \.{'} \.{=} {\langle} [ procedure \.{\mapsto}\@s{4.1}\@w{perform\_move} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}}\@s{134.02} pc\@s{33.97}
 \.{\mapsto}\@s{1.48}\@w{Run} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 126\hspace{1em}}\@s{134.02} move\@s{17.88}
 \.{\mapsto}\@s{4.1} move ] {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 127\hspace{1em}}\@s{131.45} \.{\circ} stack}%
 \@x{\makebox[0pt][r]{\scriptsize 128\hspace{1em}}\@s{66.19} \.{\land} pc
 \.{'} \.{=}\@w{Move}}%
 \@x{\makebox[0pt][r]{\scriptsize 129\hspace{1em}}\@s{66.19} \.{\land}
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 132\hspace{1em}} Terminating \.{\defeq} pc
 \.{=}\@w{Done} \.{\land} {\UNCHANGED} vars}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 134\hspace{1em}} Next \.{\defeq}
 perform\_move \.{\lor} Run \.{\lor} MakeMove}%
 \@x{\makebox[0pt][r]{\scriptsize 135\hspace{1em}}\@s{52.13} \.{\lor}
 Terminating}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 137\hspace{1em}} Spec\@s{1.46} \.{\defeq}
 Init \.{\land} {\Box} [ Next ]_{ vars}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 139\hspace{1em}} Termination \.{\defeq}
 {\Diamond} ( pc \.{=}\@w{Done} )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 141\hspace{1em}}}%
\@y{\@s{0}%
 END TRANSLATION
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 143\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 13:11:55 \ensuremath{CET} 2020 by \ensuremath{ostera
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
